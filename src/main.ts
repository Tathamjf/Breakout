import { Actor, CollisionType, Color, Text, Engine, vec, Font, Label, FontUnit, Loader, Sound } from "excalibur"
...
const queda = new Sound('./songs/queda.mp3');
